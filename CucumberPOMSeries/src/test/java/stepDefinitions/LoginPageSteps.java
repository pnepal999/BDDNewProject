...
public class LoginPageSteps {
	...
	public void page_title_should_be(String expectedTitleName) {
		// Assert.assertTrue(title.concat("expectedTitleName"));
		Assert.assertTrue(title.contains(expectedTitleName));
	}

	@Then("forgerget your password link should be displayed")
	public void forgerget_your_password_link_should_be_displayed() {
		Assert.assertTrue(loginPage.isForgetPwdLinkPresent());
	}
